...
@endphp
    {{-- @dd($schedule->trainingScheduleFacilities) --}}
        ...
        <div class="container mx-auto px-6 max-w-3xl">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 font-medium">
                    Training {{ $schedule->trainingType->name . ' (' . $schedule->trainingType->full_name . ') ' . $schedule->location }} 
                </p>
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-blue-600 font-semibold">
                                {{ $schedule->trainingType->name }} Batch
                                {{ \Carbon\Carbon::parse($schedule->start_date)->format('F Y') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">
                                <strong>Hari:</strong>
                                {{ \Carbon\Carbon::parse($schedule->start_date)->format('l') }} -
                                {{ \Carbon\Carbon::parse($schedule->end_date)->format('l') }}
                            </span>
                        </div>
                        <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">
                                ...
                                <span
                                    class="px-2 py-1 rounded-full text-sm font-medium {{ $schedule->status == 'open' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-orange-100">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        @foreach ($schedule->trainingScheduleFacilities as $item)
                            <div class="flex items-center p-3 bg-orange-50 rounded-lg">
                                {{-- <i class="fas fa-coffee text-orange-500 mr-3"></i> --}}
                                <div class="text-orange-500 min-h-6 min-w-6 mr-2">
                                    {!! $item->facility->icon !!}
                                </div>
                                <span class="text-sm font-medium text-gray-700">{{$item->facility->name}}</span>
                            </div>
                        @endforeach
                    </div>
                    {{-- <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="flex items-center p-3 bg-orange-50 rounded-lg">
                            ...
                            <span class="text-sm font-medium text-gray-700">RouterBOARD dipinjamkan</span>
                        </div>
                        <div class="flex items-center p-3 bg-orange-50 rounded-lg">
                    ...
                    <form action="{{ route('register.submit') }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="tshirt_size" id="tshirt_size" required
                                ...
                                <option value="XS" {{ old('tshirt_size') == 'XS' ? 'selected' : '' }}>XS (Extra Small)
                                </option>
                                <option value="S" {{ old('tshirt_size') == 'S' ? 'selected' : '' }}>S (Small)
                                </option>
                                <option value="M" {{ old('tshirt_size') == 'M' ? 'selected' : '' }}>M (Medium)
                                </option>
                                <option value="L" {{ old('tshirt_size') == 'L' ? 'selected' : '' }}>L (Large)
                                </option>
                                <option value="XL" {{ old('tshirt_size') == 'XL' ? 'selected' : '' }}>XL (Extra Large)
                                </option>
                                <option value="XXL" {{ old('tshirt_size') == 'XXL' ? 'selected' : '' }}>XXL (Double
                                    Extra Large)</option>
                            </select>
                            @error('tshirt_size')
                                <p class="text-red-500 text-sm mt-1">{{ $message ?? '' }}</p>
