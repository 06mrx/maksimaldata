    ...
    <div class="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <form action="{{ route('admin.training-types.update', $trainingType) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="full_name" id="full_name" value="{{ old('full_name', $trainingType->full_name) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            {{-- <div class="mb-6">
                ...
                <input type="number" name="duration_hours" id="duration_hours" value="{{ old('duration_hours', $trainingType->duration_hours) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div> --}}
